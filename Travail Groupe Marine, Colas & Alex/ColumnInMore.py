...
with open('traiteur_ColumnInMore.csv', encoding='utf-8') as csv_file:
    contenu_csv = csv.reader(csv_file, delimiter=';')
    next(contenu_csv) #Ne pas le mettre car si un jour il n'y a plus d'en tête
